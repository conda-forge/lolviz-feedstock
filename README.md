...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/lolviz-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13267&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/lolviz-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `lolviz` can be installed with:

```
conda install lolviz
```

It is possible to list all of the versions of `lolviz` available on your platform with:
